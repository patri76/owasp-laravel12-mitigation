        ...
        <div class="col-md-10 col-lg-8">
          <div class="card shadow-lg border-0 rounded-4 overflow-hidden mb-4 position-relative">
            <div class="position-relative">
              <img src="https://placehold.co/1000x150/lightblue/white?text="
                   class="card-img-top"
                   alt="..."
              ...
              <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-end p-4" style="pointer-events:none;">
                <h1 class="display-4 fw-bold text-white mb-2" style="text-shadow: 2px 2px 8px #000;">
                  {{ $article->title }}
                </h1>
                ...
                @forelse ($article->comments as $comment)
                  <div class="mb-3 p-3 bg-light rounded-3 border">
                    <b class="text-primary">
                      ...
                      {{ $comment->user->name }}
                      {{ auth()->check() && $comment->user_id === auth()->id() ? ' (you)' : '' }}:
                    </b>
